    ...
    <div className='bg-[#191919]/60 h-screen w-full top-0 left-0'>
      {showExitOptions ? (<ExitGame showExitOptions={showExitOptions} setShowExitOptions={setShowExitOptions} />) : (<div className='flex flex-col justify-center items-center h-screen'>
        <div className='flex justify-end w-[60%] -mt-20'>
          ...
          <img className='-mb-[115px] z-30' src='/sad-look.png' alt='lost-look' width={106} height={106} />
          ...
          <button className='btn border-none bg-white text-primary font-bold text-[12px] w-[190px] rounded-[10px]'><img src='/telegram-share.png' alt='winner-bg' width={24} height={24} /> Tell your friends</button>
          <button onClick={() => router.push('/create-game')} className='btn border-none bg-white text-primary font-bold text-[12px] w-[190px] rounded-[10px]'><img src='/rematch.png' alt='winner-bg' width={24} height={24} /> Rematch</button>
          <button onClick={() => handleExitOptions()} className='btn border-none bg-white text-primary font-bold text-[12px] w-[190px] rounded-[10px]'><img src='/exit.png' alt='winner-bg' width={24} height={24} /> Exit Game</button>
          </div>
      </div>)}
    </div>
  )
