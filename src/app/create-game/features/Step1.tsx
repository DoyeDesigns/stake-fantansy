...
const Step1: React.FC<Step1Props> = ({ value, onChange, stakeDetails }) => {
  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <h1 className='font-bold text-[19px] text-white text-center'>Stake SOL</h1>
      ...
      <div className='flex items-center justify-between mb-7'>
        <span className='text-white text-[15px]'>Select SOL Amount</span>
        <span className='bg-white rounded-[7px] h-[38px] px-[10px] inline-flex justify-center items-center text-primary font-extrabold text-[15px]'>SOL</span>
      </div>
